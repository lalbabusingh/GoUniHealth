...
public class LoginInfo {
    ...
    private String allergyToMedicines;
    ...
    public String getAllergyToMedicines() {
        return allergyToMedicines;
    }

    public void setAllergyToMedicines(String allergyToMedicines) {
        this.allergyToMedicines = allergyToMedicines;
    }
