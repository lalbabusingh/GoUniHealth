...
public class PharmacyActivity extends AppCompatActivity {
    ...
    class GetPharmacyListAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                response = JsonData.getNearByPharmacyList(PharmacyActivity.this, ApiManager.PHARMACY_LIST,currentLatitude,currentLongitude);
        ...
        protected void onPostExecute(String result) {
            if (result != null && result.trim().length() > 1) {
                ...
                if(totalCount == 0){
                    CommonMethods.showToastMessage(PharmacyActivity.this,getString(R.string.mesgNoData));
                }
                if (progress != null) {
                    progress.dismiss();
                }
